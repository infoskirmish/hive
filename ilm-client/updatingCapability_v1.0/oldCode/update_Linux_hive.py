...
if len(sys.argv) != 2:
        ...
        if os.path.isfile("hiveLinuxConfiguration.py"):
		pass
	else:
		...
		#
		#    Create the hiveLinuxConfiguration.py file...
		#
		configFile = open("./hiveLinuxConfiguration.py", "w")
		configFile.write('#!/usr/bin/python\n')
		configFile.write('# Filename: hiveLinuxConfiguration.py\n')
		configFile.write('\n')
		...
		configFile.write('\n')
		configFile.write('# End of hiveLinuxConfiguration.py\n')
		configFile.close()

if os.path.isfile("hiveLinuxConfiguration.py"):
	print "Reading from hiveLinuxConfiguration.py"
	from hiveLinuxConfiguration import *
