...
if len(sys.argv) != 2:
        ...
        if os.path.isfile("hiveSolarisConfiguration.py"):
		pass
	else:
		...
		#
		#    Create the hiveSolarisConfiguration.py file...
		#
		configFile = open("./hiveSolarisConfiguration.py", "w")
		configFile.write('#!/usr/bin/python\n')
		configFile.write('# Filename: hiveSolarisConfiguration.py\n')
		configFile.write('\n')
		...
		configFile.write('\n')
		configFile.write('# End of hiveSolarisConfiguration.py\n')
		configFile.close()

if os.path.isfile("hiveSolarisConfiguration.py"):
	print "Reading from hiveSolarisConfiguration.py"
	from hiveSolarisConfiguration import *
...
#cutT.sendline("  file put hived-solaris-sparc-PATCHED /export/home/newhive")
...
#cutT.sendline("  cmd exec \"chmod 755 /export/home/newhive\"")
...
#cutT.sendline("  file put install_Solaris_script /export/home/installScript")
...
#cutT.sendline("  cmd exec \"chmod 755 /export/home/installScript\"")
...
now=datetime.now()
#cutT.sendline("  cmd exec /export/home/installScript")
